...
5. **Ordenação por coluna** direto no cabeçalho da tabela, nos dois relatórios.
6. **"Causa do desligamento" virou "Motivo do desligamento"**, "Atendente" virou "Usuário", e o menu lateral virou **"Relatórios"** (era "Relatório de Chamadas").
